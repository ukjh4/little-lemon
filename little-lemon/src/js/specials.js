    ...
    <section className="specials">
      ...
      <div className="specials-container">
        ...
        <div className="special-item">
          ...
          <h3>Beef Steak</h3>
          <p>
            A succulent cut of prime beef steak, chargrilled to your preference,
            and seasoned with our signature blend of herbs. Accompanied by
            roasted garlic mashed potatoes and glazed seasonal vegetables.
          </p>
